...
I'm a MERN and Next.js developer with a strong passion for solving real-world problems using modern technologies. I specialize in creating full-stack applications, building REST APIs, and crafting responsive UIs that deliver great user experiences.
...
1. [Job Portal](https://github.com/usman918dev/job-portal)
   A job platform project focused on posting jobs, managing applications, and improving the hiring workflow.

2. [Vuedu](https://vuedu.dev/)
   A live education-focused platform built to deliver learning content with a smooth and user-friendly experience.

3. [Cost Construction System](https://github.com/zain-khokhar/cost-construction-system)
   A construction cost management system for tracking project budgets, expenses, and financial planning.

4. [Techolyze](https://techolyze.com/)
   A modern AI and technology blog platform with clean content presentation and rich reading experience.

5. [WhatsApp Agent](https://github.com/usman918dev/whatsapp-agent)
   A WhatsApp automation agent that sends preferred PDF files according to student messages.

6. [Wellness Tracker CRUD](https://github.com/usman918dev/weellness-tracker-crud)
   A wellness tracking CRUD app to manage daily wellness records and support healthy habit monitoring.
